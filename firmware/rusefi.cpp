 ...
 *
 * Detailed documentation is available in [firmware/controllers/trigger/readme.md](controllers/trigger/readme.md)
 *
 ...
 *
 * trigger sync is tricky enough that we usually sync on a pretty specific point which has nothing to do with actual engine TDC. trigger offset is used to match sync point with TDC
 *
