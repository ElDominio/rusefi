// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/modules/wot_enrichment/wot_enrichment_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of wot_enrichment_state_s
struct wot_enrichment_state_s {
	/**
	 * WOT Enrichment: active
	offset 0 bit 0 */
	bool isWotEnrichmentActive : 1 {};
	/**
	offset 0 bit 1 */
	...
	/**
	 * WOT Enrichment: time at WOT
	 * units: s
	 * offset 4
	 */
	float wotEnrichmentTimer = (float)0;
	/**
	 * WOT Enrichment: AFR adder
	 * units: afr
	 * offset 8
	 */
	float wotEnrichmentAfrAdder = (float)0;
};
static_assert(sizeof(wot_enrichment_state_s) == 12);
