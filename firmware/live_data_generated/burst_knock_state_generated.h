// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/modules/burst_knock/burst_knock_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of burst_knock_state_s
struct burst_knock_state_s {
	/**
	 * Burst Knock: active
	offset 0 bit 0 */
	bool isBurstKnockActive : 1 {};
	/**
	offset 0 bit 1 */
	...
	/**
	 * Burst Knock: timing pull
	 * units: deg
	 * offset 4
	 */
	float burstKnockRetard = (float)0;
	/**
	 * Burst Knock: TPS rate
	 * units: %/s
	 * offset 8
	 */
	float burstKnockTpsRate = (float)0;
};
static_assert(sizeof(burst_knock_state_s) == 12);
