// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/modules/cdv_controller/cdv_controller_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of cdv_controller_state_s
struct cdv_controller_state_s {
	/**
	offset 0 bit 0 */
	bool isCdvActive : 1 {};
	/**
	offset 0 bit 1 */
	bool isCdvTimeExitCondition : 1 {};
	/**
	offset 0 bit 2 */
	bool isCdvVssExitCondition : 1 {};
	/**
	offset 0 bit 3 */
	bool isCdvClutchExitCondition : 1 {};
	/**
	offset 0 bit 4 */
	bool isCdvWindowExitCondition : 1 {};
	/**
	offset 0 bit 5 */
	bool isCdvPressureInWindow : 1 {};
	/**
	offset 0 bit 6 */
...
static_assert(sizeof(cdv_controller_state_s) == 4);
