// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/modules/launch_power_ramp/launch_power_ramp_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of launch_power_ramp_state_s
struct launch_power_ramp_state_s {
	/**
	offset 0 bit 0 */
	bool isLaunchPowerRampActive : 1 {};
	/**
	offset 0 bit 1 */
	 ...
	 * offset 4
	 */
	float launchPowerRampRetard = (float)0;
	/**
	 * "s"
	 * offset 8
	 */
	float launchPowerRampElapsed = (float)0;
};
static_assert(sizeof(launch_power_ramp_state_s) == 12);
