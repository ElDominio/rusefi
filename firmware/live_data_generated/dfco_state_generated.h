// this section was generated automatically by rusEFI tool config_definition_base-all.jar based on (unknown script) controllers/algo/fuel/dfco_state.txt
// by class com.rusefi.output.CHeaderConsumer
// begin
#pragma once
#include "rusefi_types.h"
// start of dfco_state_s
struct dfco_state_s {
	/**
	 * DFCO fuel cut is currently active
	offset 0 bit 0 */
	bool dfcoCutActive : 1 {};
	/**
	offset 0 bit 1 */
...
static_assert(sizeof(dfco_state_s) == 4);
