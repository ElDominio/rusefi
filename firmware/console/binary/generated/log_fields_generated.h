...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels.VIgn, "VIgn", "V", 2},
	...
	{engine->outputChannels.actualLastInjectionRatio, "Fuel: Last inj pulse growth", "", 3},
	...
	{engine->outputChannels.flexAeMultiplier, "Flex: AE multiplier", "mult", 3},
	{engine->outputChannels.flexWwTauMultiplier, "Flex: WW tau multiplier", "mult", 3},
	...
	{engine->outputChannels.rawClutchPressure, "rawClutchPressure", "V", 3},
	...
	{engine->outputChannels.predTimerResetCnt, "AE: Map Pred New Cycles", "", 0},
	{engine->outputChannels.mapPredEventOver, "AE: Map Pred Expired", "", 0},
	...
	{engine->outputChannels.alternatorVoltageTarget, "alternatorVoltageTarget", "V", 2},
	{engine->outputChannels.alternatorBaseDuty, "Alternator base duty (table)", "%", 1},
	{engine->outputChannels.alternatorOutputDuty, "Alternator duty (base+PID)", "%", 1},
	...
	{engine->outputChannels.secondVeBlendParameter, "secondVeBlendParameter", "", 1},
	{engine->outputChannels.secondVeBlendBias, "secondVeBlendBias", "%", 1},
	{engine->outputChannels.secondIgnitionBlendParameter, "secondIgnitionBlendParameter", "", 1},
	{engine->outputChannels.secondIgnitionBlendBias, "secondIgnitionBlendBias", "%", 1},
	...
	{engine->outputChannels.targetAfrBlendYAxis[0], "targetAfrBlendYAxis 1", "", 1},
	{engine->outputChannels.targetAfrBlendYAxis[1], "targetAfrBlendYAxis 2", "", 1},
	{engine->outputChannels, 728, 0, "coilState1", ""},
	{engine->outputChannels, 728, 1, "coilState2", ""},
	{engine->outputChannels, 728, 2, "coilState3", ""},
	{engine->outputChannels, 728, 3, "coilState4", ""},
	{engine->outputChannels, 728, 4, "coilState5", ""},
	{engine->outputChannels, 728, 5, "coilState6", ""},
	{engine->outputChannels, 728, 6, "coilState7", ""},
	{engine->outputChannels, 728, 7, "coilState8", ""},
	{engine->outputChannels, 728, 8, "coilState9", ""},
	{engine->outputChannels, 728, 9, "coilState10", ""},
	{engine->outputChannels, 728, 10, "coilState11", ""},
	{engine->outputChannels, 728, 11, "coilState12", ""},
	{engine->outputChannels, 728, 12, "injectorState1", ""},
	{engine->outputChannels, 728, 13, "injectorState2", ""},
	{engine->outputChannels, 728, 14, "injectorState3", ""},
	{engine->outputChannels, 728, 15, "injectorState4", ""},
	{engine->outputChannels, 728, 16, "injectorState5", ""},
	{engine->outputChannels, 728, 17, "injectorState6", ""},
	{engine->outputChannels, 728, 18, "injectorState7", ""},
	{engine->outputChannels, 728, 19, "injectorState8", ""},
	{engine->outputChannels, 728, 20, "injectorState9", ""},
	{engine->outputChannels, 728, 21, "injectorState10", ""},
	{engine->outputChannels, 728, 22, "injectorState11", ""},
	{engine->outputChannels, 728, 23, "injectorState12", ""},
	{engine->outputChannels, 728, 24, "triggerChannel1", ""},
	{engine->outputChannels, 728, 25, "triggerChannel2", ""},
	{engine->outputChannels, 728, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 728, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 728, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 728, 29, "bank 2 exhaust cam input", ""},
	{engine->outputChannels, 728, 30, "AE: Map Prediction Active", ""},
	{engine->outputChannels, 728, 31, "Error: Flex", ""},
	...
	{engine->outputChannels.cylHeadTemperature, "Cylinder head temperature (CHT)", "deg C", 1},
	{engine->outputChannels.rawCht, "CHT sensor raw voltage", "V", 3},
	{engine->outputChannels.cltEstAirflow, "CLT estimator airflow", "CFM", 1},
	{engine->outputChannels.cltEstRejectionRate, "CLT estimator rejection rate", "1/s", 4},
	{engine->outputChannels.cltEstValvePos, "CLT estimator valve position", "ratio", 3},
	...
	{engine->outputChannels.actualLastInjectionRatioStage2, "Fuel: Last inj pulse growth stg 2", "", 3},
	...
	{engine->outputChannels.clutchPressure, "Clutch pressure", "kPa", 0},
	...
	{engine->ignitionState.vvtIntakeTimingCorrection, "Ign: VVT Intake correction", "deg", 2, "Timing"},
	{engine->ignitionState.vvtExhaustTimingCorrection, "Ign: VVT Exhaust correction", "deg", 2, "Timing"},
	{engine->ignitionState.dfcoTimingRetard, "DFCO: Timing retard", "deg", 2},
	{engine->ignitionState, 24, 0, "P&B: timing override active", ""},
	...
	{engine->ignitionState, 48, 0, "Ign: Lua Spark Skip", ""},
	...
	{*engine->module<FanControl1>(), 0, 5, "fan1Enable for AC pressure", ""},
	{*engine->module<FanControl1>(), 0, 6, "fan1Above hot threshold", ""},
	{*engine->module<FanControl1>(), 0, 7, "fan1Below cold threshold", ""},
	{*engine->module<FanControl1>(), 0, 8, "fan1disabledBySpeed", ""},
	{*engine->module<FanControl1>(), 0, 9, "fan1On", ""},
	{engine->module<FanControl1>()->radiatorFanStatus, "fan1radiatorFanStatus", "", 0},
	{engine->module<FanControl1>()->pwmCurvePwm, "fan1PWM from curve", "", 0},
	{engine->module<FanControl1>()->pwmTargetPwm, "fan1PWM target", "", 0},
	{engine->module<FanControl1>()->pwmAppliedPwm, "fan1PWM applied", "", 0},
	{*engine->module<FanControl1>(), 20, 0, "fan1PWM mode active", ""},
	...
	{*engine->module<FanControl2>(), 0, 5, "fan2Enable for AC pressure", ""},
	{*engine->module<FanControl2>(), 0, 6, "fan2Above hot threshold", ""},
	{*engine->module<FanControl2>(), 0, 7, "fan2Below cold threshold", ""},
	{*engine->module<FanControl2>(), 0, 8, "fan2disabledBySpeed", ""},
	{*engine->module<FanControl2>(), 0, 9, "fan2On", ""},
	{engine->module<FanControl2>()->radiatorFanStatus, "fan2radiatorFanStatus", "", 0},
	{engine->module<FanControl2>()->pwmCurvePwm, "fan2PWM from curve", "", 0},
	{engine->module<FanControl2>()->pwmTargetPwm, "fan2PWM target", "", 0},
	{engine->module<FanControl2>()->pwmAppliedPwm, "fan2PWM applied", "", 0},
	{*engine->module<FanControl2>(), 20, 0, "fan2PWM mode active", ""},
	...
	{engine->engineState.lua.engineTorque, "Lua: torque", "", 0},
	{engine->engineState, 60, 0, "lua.clutchUpState", ""},
	{engine->engineState, 60, 1, "lua.brakePedalState", ""},
	{engine->engineState, 60, 2, "lua.acRequestState", ""},
	{engine->engineState, 60, 3, "lua.luaDisableEtb", ""},
	{engine->engineState, 60, 4, "lua.luaIgnCut", ""},
	{engine->engineState, 60, 5, "lua.luaFuelCut", ""},
	{engine->engineState, 60, 6, "lua.clutchDownState", ""},
	{engine->engineState, 60, 7, "lua.disableDecelerationFuelCutOff", ""},
	{engine->engineState, 60, 8, "lua.torqueReductionState", ""},
	...
	{engine->engineState, 96, 0, "startStopPhysicalState", ""},
	{engine->engineState, 96, 1, "Harley ACR Active", ""},
	{engine->engineState, 96, 2, "VE: Second table active", ""},
	{engine->engineState, 96, 3, "IGN: Second table active", ""},
	{engine->engineState, 96, 4, "acrEngineMovedRecently", ""},
	{engine->engineState, 96, 5, "heaterControlEnabled", ""},
	{engine->engineState, 96, 6, "luaDigitalState0", ""},
	{engine->engineState, 96, 7, "luaDigitalState1", ""},
	{engine->engineState, 96, 8, "luaDigitalState2", ""},
	{engine->engineState, 96, 9, "luaDigitalState3", ""},
	{engine->engineState, 96, 10, "Clutch: down", ""},
	...
	{engine->engineState.tractionControlYAxisValue, "tractionControlYAxisValue", "", 2},
	{engine->engineState.veTableIdleYAxis, "veTableIdleYAxis", "", 1},
	{engine->engineState.overDwellCanceledCounter, "Ignition: overcharge canceled", "", 0},
	{engine->engineState.overDwellNotScheduledCounter, "Ignition: overDwellNotScheduled", "", 0},
	{engine->engineState.sparkOutOfOrderCounter, "Ignition: sparkOutOfOrder", "", 0},
	{engine->engineState.dwellUnderChargeCounter, "Ignition: undecharge warnings", "", 0},
	{engine->engineState.dwellOverChargeCounter, "Ignition: overcharge warnings", "", 0},
	{engine->engineState.dwellActualRatio, "Ignition: Dwell deviation", "%", 1},
	...
	{engine->fuelComputer.vvtFuelIntakeCorrection, "Fuel: VVT Intake correction", "%", 1, "Fuel: math"},
	{engine->fuelComputer.vvtFuelExhaustCorrection, "Fuel: VVT Exhaust correction", "%", 1, "Fuel: math"},
	...
	{engine->fuelComputer, 56, 0, "injectorHwIssue", ""},
#endif
	...
	{engine->launchController, 4, 4, "Launch: isClutchDownActivated", ""},
	{engine->launchController, 4, 5, "Launch: isClutchUpActivated", ""},
	{engine->launchController, 4, 6, "Launch: isClutchUpDisabled", ""},
	{engine->launchController, 4, 7, "isBrakePedalActivated", ""},
	{engine->launchController, 4, 8, "Launch: isValidInputPin", ""},
	{engine->launchController, 4, 9, "Launch: activateSwitchCondition", ""},
	{engine->launchController, 4, 10, "rpmLaunchCondition", ""},
	{engine->launchController, 4, 11, "rpmPreLaunchCondition", ""},
	{engine->launchController, 4, 12, "Launch: speedCondition", ""},
	{engine->launchController, 4, 13, "Launch: tpsCondition", ""},
	{engine->launchController, 4, 14, "luaLaunchState", ""},
	{engine->launchController, 4, 15, "Launch: isLaunchLatched", ""},
	...
	{getLiveDataConstexpr<electronic_throttle_s, 0>()->trim, "etb1ETB: trim", "%", 2, "ETB more"},
	{getLiveDataConstexpr<electronic_throttle_s, 0>()->adjustedEtbTarget, "etb1ETB: target with adjustments", "%", 2, "ETB more"},
	{getLiveDataConstexpr<electronic_throttle_s, 0>()->m_adjustedTarget, "etb1ETB: final target", "%", 2, "ETB more"},
	...
	{*getLiveDataConstexpr<electronic_throttle_s, 0>(), 40, 3, "etb1sportPedalActive", ""},
	...
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->etbCurrentTarget, "etb2ETB: target for current pedal", "%", 2, "ETB more"},
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->boardEtbAdjustment, "etb2ETB: board adjustment", "%", 2, "ETB more"},
	...
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->trim, "etb2ETB: trim", "%", 2, "ETB more"},
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->adjustedEtbTarget, "etb2ETB: target with adjustments", "%", 2, "ETB more"},
	{getLiveDataConstexpr<electronic_throttle_s, 1>()->m_adjustedTarget, "etb2ETB: final target", "%", 2, "ETB more"},
	...
	{*getLiveDataConstexpr<electronic_throttle_s, 1>(), 40, 3, "etb2sportPedalActive", ""},
	...
	{engine->module<IdleController>().unmock(), 8, 0, "idle: mightResetPid", ""},
	{engine->module<IdleController>().unmock(), 8, 1, "Idle: shouldResetPid", ""},
	{engine->module<IdleController>().unmock(), 8, 2, "Idle: wasResetPid", ""},
	{engine->module<IdleController>().unmock(), 8, 3, "Idle: cranking", ""},
	{engine->module<IdleController>().unmock(), 8, 4, "isIacTableForCoasting", ""},
	{engine->module<IdleController>().unmock(), 8, 5, "Idle: reset", ""},
	{engine->module<IdleController>().unmock(), 8, 6, "Idle: dead zone", ""},
	{engine->module<IdleController>().unmock(), 8, 7, "isBlipping", ""},
	{engine->module<IdleController>().unmock(), 8, 8, "badTps", ""},
	{engine->module<IdleController>().unmock(), 8, 9, "looksLikeRunning", ""},
	{engine->module<IdleController>().unmock(), 8, 10, "looksLikeCoasting", ""},
	{engine->module<IdleController>().unmock(), 8, 11, "looksLikeCrankToIdle", ""},
	{engine->module<IdleController>().unmock(), 8, 12, "Idle: coasting", ""},
	{engine->module<IdleController>().unmock(), 8, 13, "Idle: Closed loop active", ""},
	{engine->module<IdleController>().unmock(), 8, 14, "Idle: idling", ""},
	...
	{engine->module<IdleController>().unmock(), 52, 0, "Idle: off-idle adder active", ""},
	{engine->module<IdleController>().unmock().offIdleAdderCurrentRpm, "Idle: off-idle adder RPM", "RPM", 0},
	{engine->module<IdleController>().unmock().offIdleAdderStateIndex, "Idle: off-idle adder state", "", 0},
#endif
