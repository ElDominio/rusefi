...
static LOG_FIELD_CONSTNESS_SPECIFIER_STORAGE MLG::Entries::Field fields[] = {
	...
	{engine->outputChannels, 712, 0, "coilState1", ""},
	{engine->outputChannels, 712, 1, "coilState2", ""},
	{engine->outputChannels, 712, 2, "coilState3", ""},
	{engine->outputChannels, 712, 3, "coilState4", ""},
	{engine->outputChannels, 712, 4, "coilState5", ""},
	{engine->outputChannels, 712, 5, "coilState6", ""},
	{engine->outputChannels, 712, 6, "coilState7", ""},
	{engine->outputChannels, 712, 7, "coilState8", ""},
	{engine->outputChannels, 712, 8, "coilState9", ""},
	{engine->outputChannels, 712, 9, "coilState10", ""},
	{engine->outputChannels, 712, 10, "coilState11", ""},
	{engine->outputChannels, 712, 11, "coilState12", ""},
	{engine->outputChannels, 712, 12, "injectorState1", ""},
	{engine->outputChannels, 712, 13, "injectorState2", ""},
	{engine->outputChannels, 712, 14, "injectorState3", ""},
	{engine->outputChannels, 712, 15, "injectorState4", ""},
	{engine->outputChannels, 712, 16, "injectorState5", ""},
	{engine->outputChannels, 712, 17, "injectorState6", ""},
	{engine->outputChannels, 712, 18, "injectorState7", ""},
	{engine->outputChannels, 712, 19, "injectorState8", ""},
	{engine->outputChannels, 712, 20, "injectorState9", ""},
	{engine->outputChannels, 712, 21, "injectorState10", ""},
	{engine->outputChannels, 712, 22, "injectorState11", ""},
	{engine->outputChannels, 712, 23, "injectorState12", ""},
	{engine->outputChannels, 712, 24, "triggerChannel1", ""},
	{engine->outputChannels, 712, 25, "triggerChannel2", ""},
	{engine->outputChannels, 712, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 712, 27, "bank 1 exhaust cam input", ""},
