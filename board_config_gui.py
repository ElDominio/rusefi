...
CURATED_FLAGS = [
    ...
    ("EFI_LAUNCH_POWER_RAMP", "Launch Power Ramp (timing pull after WOT launch)"),
    ("EFI_BURST_KNOCK", "Burst Knock (transient timing pull on TPS stab)"),
    ("EFI_WOT_ENRICHMENT", "WOT Time Enrichment (AFR adder at sustained WOT; needs ESM)"),
...
ALL_KNOWN_FLAGS = [
    ...
    "EFI_BOOST_CONTROL", "EFI_BOR_LEVEL", "EFI_BOSCH_YAW", "EFI_BURST_KNOCK", "EFI_CAN_GPIO", "EFI_CAN_SERIAL",
    ...
    "EFI_INTERNAL_SLOW_ADC_BACKGROUND", "EFI_LAUNCH_CONTROL", "EFI_LAUNCH_POWER_RAMP", "EFI_LOGIC_ANALYZER",
    ...
    "EFI_WOT_ENRICHMENT", "EFI_WS2812", "ROTATIONAL_IDLE_CONTROLLER", "MODULE_CDV_CONTROLLER", "MODULE_CONFIGURATION_WIZARD",
